...
function Instructions() {
  return (
    <section className="instructions">
      ...
      <ul>
        <li><strong>Step 1:</strong> <em>Create or Import Wallet</em> If you don't have an XRP wallet yet, create a new one by clicking 'generate wallet'. Make sure to copy this information down. If you already have a wallet, you can import it by entering your secret key to check your wallet balance.</li>
